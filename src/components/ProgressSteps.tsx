...
const ProgressSteps: FunctionComponent<ProgressStepsType> = ({
  className = "",
  step = 1,
  stepState,
  stepState1,
  ...
  return (
    <div
      className={`w-[361px] flex flex-row items-center justify-center text-center text-sm text-Backgrounds-Primary font-noto-sans-tc ${className}`}
      data-step={step}
    >
      <StepLine
        step="Start"
