  ...
  ({ className = "" }) => {
    return (
      ...
      >
        ...
        />
        <section className="flex flex-col items-center justify-start !pt-spacing-spacing-xl !pb-spacing-spacing-2xl !pl-spacing-spacing-md !pr-spacing-spacing-md gap-spacing-spacing-2xl z-[1] text-left text-sm text-fg-fg-secondary font-['Noto_Sans_TC']">
          <ProgressSteps
            step={1}
            stepState="Completed"
