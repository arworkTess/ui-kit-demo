...
const StatusBarIPhone: FunctionComponent<StatusBarIPhoneType> = ({
  className = "",
  background = true,
}) => {
  return (
    <div
      className={`w-[393px] h-[50px] bg-Backgrounds-Primary flex flex-col items-start justify-start !pt-[21px] !pb-0 !pl-0 !pr-0 box-border z-[3] text-center text-[17px] text-Labels-Primary font-sf-pro ${className}`}
