...
const InputText: FunctionComponent<InputTextType> = memo(
  ({
    ...
    return (
      <div
        className={`self-stretch shadow-[0px_1px_2px_rgba(0,_0,_0,_0.05)] rounded-radius-radius-md bg-bg-bg-primary border-border-border-secondary border-solid border-[1px] overflow-hidden flex flex-row items-center justify-start !pt-spacing-spacing-sm !pb-spacing-spacing-sm !pl-spacing-spacing-md !pr-spacing-spacing-md gap-spacing-spacing-sm text-left text-base text-fg-fg-disabled font-noto-sans-tc ${className}`}
        data-state={state}
      >
        {!!iconLeft && (
          <img
